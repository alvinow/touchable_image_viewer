...
/// Desktop-optimized toolbar with compact design
class DesktopToolbar extends StatelessWidget {
  ...
  void _showBackgroundPicker(BuildContext context) {
    // Desktop: Use dialog (compact, centered)
    showDialog(
      context: context,
...
/// Desktop toolbar button with compact design (40x40)
