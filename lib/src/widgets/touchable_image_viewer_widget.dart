...
import 'toolbar/floating_toolbar.dart';
import 'renderers/raster_image_renderer.dart';
import 'renderers/svg_renderer.dart';

/// Main touchable image viewer widget
class TouchableImageViewer extends StatefulWidget {
  ...
  @override
  State<TouchableImageViewer> createState() => _TouchableImageViewerState();
}

class _TouchableImageViewerState extends State<TouchableImageViewer>
  ...
  Widget _buildImageRenderer() {
    // For now, handle raster and SVG
    // DXF and STL will be added in Phase 2
  ...
  void _handleScaleUpdate(ScaleUpdateDetails details) {
    setState(() {
      if (widget.config.enableZoom && details.scale != 1.0) {
        ...
        // Update transformation with focal point
  ...
  void _handleScaleEnd(ScaleEndDetails details) {
    // Could add momentum/inertia animation here
  }
